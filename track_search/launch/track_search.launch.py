...
def launch_setup(context, *args, **kwargs):
    pkg_share = get_package_share_directory('track_search')
    ...
    gps_runner_command = str(
        os.environ.get(
            'TRACK_SEARCH_GPS_RUNNER_COMMAND',
    ...
    if gps_runner_command:
        ...
        nodes.append(
            LogInfo(
                ...
                '(set gps_runner_bridge_node.runner_command or TRACK_SEARCH_GPS_RUNNER_COMMAND)'
            )
        )
